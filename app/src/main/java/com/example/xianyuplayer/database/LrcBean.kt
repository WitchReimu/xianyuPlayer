...
/**
 * @param time 歌词开始时间，单位毫秒
 * @param text 歌词文本
 */
data class LrcBean(val time: Long, val text: String) {


    companion object {
        fun parseList(lrcFile: File): ArrayList<LrcBean> {
        ...
        private fun parseLine(line: String): ArrayList<LrcBean> {
