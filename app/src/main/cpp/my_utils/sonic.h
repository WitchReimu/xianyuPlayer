...
#ifndef XIANYUPLAYER_APP_SRC_MAIN_CPP_MY_UTILS_SONIC_H
#define XIANYUPLAYER_APP_SRC_MAIN_CPP_MY_UTILS_SONIC_H
...
#endif //XIANYUPLAYER_APP_SRC_MAIN_CPP_MY_UTILS_SONIC_H
